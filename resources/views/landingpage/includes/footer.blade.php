    ...
    <div class="container">
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2"><a href="#" class="logo">Motor<span>Link</span></a></h2>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p> Copyright &copy; All rights reserved | <a href="index.html" class="linkfotermotorlink">Motor Link</a></p>
        </div>
      </div>
    </div>
  </footer>
